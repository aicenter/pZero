...
from pzero.zoo.my_minigrid_config import main_config, create_config
...
if __name__ == "__main__":
    ...
    model_path = "./data_muzero/MiniGrid-Empty-5x5-v0_muzero_ns50_upc200_rer0_collect-eps-False_temp-final-steps-500000_pelw0.0_seed0_250527_143003/ckpt/iteration_10000.pth.tar"
    ...
    main_config.env.replay_path_gif = './data_muzero/video/'
