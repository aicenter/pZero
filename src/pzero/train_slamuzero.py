...
def train_slamuzero(
    ...
    assert create_cfg.policy.type in ['efficientzero', 'muzero', 'slamuzero', 'muzero_context', 'muzero_rnn_full_obs', 'sampled_efficientzero', 'sampled_muzero', 'gumbel_muzero', 'stochastic_muzero'], \
    ...
    # TODO: special game buffer for slamuzero
    if create_cfg.policy.type in ['muzero','slamuzero', 'muzero_context', 'muzero_rnn_full_obs']:
