...
def train_pomuzero(
    ...
    assert create_cfg.policy.type in ['efficientzero', 'muzero', 'slamuzero', 'pomuzero', 'muzero_context', 'muzero_rnn_full_obs', 'sampled_efficientzero', 'sampled_muzero', 'gumbel_muzero', 'stochastic_muzero'], \
    ...
    # TODO: special game buffer for pomuzero
    if create_cfg.policy.type in ['muzero','slamuzero','pomuzero', 'muzero_context', 'muzero_rnn_full_obs']:
